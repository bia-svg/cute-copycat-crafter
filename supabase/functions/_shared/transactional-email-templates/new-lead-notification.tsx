...
function normalizeWhatsAppNumber(raw?: string, country?: string): string | null {
  ...
  if (n.startsWith('+')) {
    ...
    const ccMap: Record<string, string> = {
      ...
      lu: '352', li: '423', pt: '351', pl: '48', cz: '420',
      dk: '45', se: '46', no: '47', fi: '358', ie: '353',
      us: '1', ca: '1', ae: '971', sa: '966', tr: '90',
      br: '55', mx: '52', ar: '54', au: '61', nz: '64',
...
export const template = {
  ...
  previewData: {
    ...
    source: 'organic',
    bookedPrice: 'CHF 2.690.-',
    priceType: 'Frühbucherpreis',
    regularPrice: 'CHF 2.990.-',
