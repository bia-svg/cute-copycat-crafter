      ...
      <section className="relative bg-[#f4f3ef] border-b border-border">
        <div className="container-main py-4 md:py-5">
          <div className="max-w-3xl mx-auto bg-white border-[1.5px] border-border rounded-3xl shadow-[0_22px_56px_-16px_rgba(27,58,92,0.22),0_6px_18px_-6px_rgba(27,58,92,0.12)] p-4 md:p-6">
            ...
            <ul className="mt-4 md:mt-4 max-w-xl mx-auto w-fit sm:w-auto pl-6 sm:pl-0 flex flex-col sm:flex-row sm:flex-wrap sm:justify-center gap-x-7 gap-y-2.5 border-t border-border pt-4">
              {bullets.map(({ icon: Icon, text }) => (
              <li key={text} className="flex items-center gap-2.5 text-[12.5px] md:text-[13.5px] text-[#0B1F33]/80 leading-snug sm:basis-[calc(50%-1rem)]">
