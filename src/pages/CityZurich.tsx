  ...
  return (
    <>
        ...
        <div className="container-main py-8 lg:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-start gap-2 text-sm text-muted-foreground border border-border p-3 bg-[#F1F4F7]">
      ...
      <FAQSection
        ...
        items={isEN ? [
          { q: "Who is the best hypnotherapist in Zurich?", a: "David J. Woods is one of the most experienced hypnotherapists in the German-speaking world, with over 35+ years of experience, 30,000+ sessions conducted, and a perfect ★ 5.0 Google rating from 266 reviews. He is EMR health insurance recognized (ZSR Nr. P609264)." },
          ...
          { q: "Wer ist der beste Hypnosetherapeut in Zürich?", a: "David J. Woods gehört zu den erfahrensten Hypnosetherapeuten im deutschsprachigen Raum mit über 35+ Jahren Erfahrung, mehr als 30.000 Sitzungen und einer perfekten ★ 5.0 Google-Bewertung aus 266 Rezensionen. Er ist EMR-anerkannt (ZSR Nr. P609264)." },
