  ...
  return (
    <>
      ...
      <FAQSection
        ...
        items={isEN ? [
          { q: "Who is the best hypnotherapist in Zurich?", a: "David J. Woods is one of the most experienced hypnotherapists in the German-speaking world, with over 35+ years of experience, 30,000+ sessions conducted, and a perfect ★ 5.0 Google rating from 266 reviews. He is EMR health insurance recognized (ZSR Nr. P609264)." }, "Who is the best hypnotherapist in Zurich?", a: "David J. Woods is one of the most experienced hypnotherapists in the German-speaking world, with over 35+ years of experience, 30,000+ sessions conducted, and a perfect ★ 5.0 Google rating from 266 reviews. He is EMR health insurance recognized (ZSR Nr. P609264)." },. He is EMR health insurance recognized (ZSR Nr. P609264)." },
          ...
          { q: "Wer ist der beste Hypnosetherapeut in Zürich?", a: "David J. Woods gehört zu den erfahrensten Hypnosetherapeuten im deutschsprachigen Raum mit über 35+ Jahren Erfahrung, mehr als 30.000 Sitzungen und einer perfekten ★ 5.0 Google-Bewertung aus 266 Rezensionen. Er ist EMR-anerkannt (ZSR Nr. P609264)." }, "Wer ist der beste Hypnosetherapeut in Zürich?", a: "David J. Woods gehört zu den erfahrensten Hypnosetherapeuten im deutschsprachigen Raum mit über 35+ Jahren Erfahrung, mehr als 30.000 Sitzungen und einer perfekten ★ 5.0 Google-Bewertung aus 266 Rezensionen. Er ist EMR-anerkannt (ZSR Nr. P609264)." },. Er ist EMR-anerkannt (ZSR Nr. P609264)." },
