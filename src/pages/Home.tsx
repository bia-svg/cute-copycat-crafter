...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="pt-5 pb-5 md:pt-6 md:pb-6 bg-primary/15" style={deferredSectionStyle}>
        <div className="mx-3 md:mx-auto md:max-w-[1200px] bg-card rounded-xl border border-primary/15 py-2 md:py-2.5 px-3 md:px-7 shadow-sm">
          <div className="grid md:grid-cols-[300px_1fr] gap-2 md:gap-7 md:items-stretch">
            ...
            <div className="order-1 md:order-2 flex flex-col items-center text-center md:pl-4 md:h-full md:pt-0 md:pb-1.5">
              ...
              <button
                ...
                className="mt-4 md:mt-auto md:mb-0 md:pt-3 inline-flex items-center justify-center bg-[#c8e6c9] hover:bg-[#a5d6a7] text-black font-medium text-[12px] md:text-[13.5px] px-4 md:px-5 py-1.5 rounded-lg shadow-sm transition-all"
              >
