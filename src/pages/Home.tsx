      ...
      <section className="py-6 md:py-10 bg-primary/15" style={deferredSectionStyle}>
        ...
        <div className="container-main">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 max-w-4xl md:max-w-5xl mx-auto">
            ...
            <div className="text-center p-3 md:p-6 bg-card border border-border rounded-lg shadow-sm transition-all duration-300 md:hover:scale-[1.15] md:hover:shadow-xl md:hover:z-10">
            ...
            {/* 2 – Aktiv-Hypnose© */}
            <div className="text-center p-3 md:p-6 bg-card border border-border rounded-lg shadow-sm flex flex-col items-center justify-center transition-all duration-300 md:hover:scale-[1.15] md:hover:shadow-xl md:hover:z-10">
