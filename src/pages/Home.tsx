...
export default function Home() {
  ...
  return (
    <>
            ...
            <div className="space-y-4 text-center">
              ...
              <div className="text-foreground/80 leading-relaxed text-[0.95rem] flex flex-col items-center">
                ...
                <ul className="space-y-1 text-sm text-left">
                  ...
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-cta shrink-0" />{isEN ? "Author of Go Inside" : "Autor von Go Inside"}</li>
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-cta shrink-0" />{isEN ? "Professional MP3 programs" : "Professionelle MP3-Programme"}</li>
          ...
          <div className="container-main py-4 space-y-3 text-center">
            ...
            <div className="text-sm text-foreground/80 leading-snug">
              ...
              <ul className="space-y-0.5 text-xs inline-block text-left">
                ...
                <li className="flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5 text-cta shrink-0" />{isEN ? "Author of Go Inside" : "Autor von Go Inside"}</li>
                <li className="flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5 text-cta shrink-0" />{isEN ? "Professional MP3 programs" : "Professionelle MP3-Programme"}</li>
      ...
      {/* ═══════════════════ SERVICES ═══════════════════ */}
      <section className="py-4 md:py-5 bg-secondary mx-3 md:mx-auto md:max-w-[1200px] border border-primary/15 rounded-2xl" style={deferredSectionStyle}>
        <div className="container-main">
      ...
      <section className="py-6 md:py-10 bg-primary/15" style={deferredSectionStyle}>
        ...
        <div className="container-main">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 max-w-4xl md:max-w-5xl mx-auto">
            ...
            <div className="text-center p-3 md:p-6 bg-card border border-border rounded-lg shadow-sm">
              <img src={licPsychSeal} alt="Lic. Psych. – Academic Seal" className="h-14 md:h-24 w-14 md:w-24 object-contain mx-auto mb-2 md:mb-3 transition-transform duration-300 md:hover:scale-125" loading="lazy" width={512} height={512} />
              <h3 className="font-semibold text-xs md:text-sm text-foreground">{isEN ? "Licensed Psychologist" : "Lizenzierter Psychologe"}</h3>
            </div>
            {/* 2 – Aktiv-Hypnose© */}
            <div className="text-center p-3 md:p-6 bg-card border border-border rounded-lg shadow-sm flex flex-col items-center justify-center">
              <img src={CDN.logo} alt="Aktiv-Hypnose© Logo" className="h-8 md:h-16 w-auto object-contain shrink-0 mx-auto mb-2 md:mb-3 transition-transform duration-300 md:hover:scale-125" loading="lazy" />
            ...
            {/* 3 – NGH */}
            <div className="text-center p-3 md:p-6 bg-card border border-border rounded-lg shadow-sm">
              <img src={CDN.nghBadge} alt="NGH International Trainer" className="h-10 md:h-20 w-10 md:w-20 object-contain mx-auto mb-2 md:mb-3 transition-transform duration-300 md:hover:scale-125" loading="lazy" />
              <h3 className="font-semibold text-xs md:text-sm text-foreground">NGH International Trainer</h3>
            </div>
            {/* 4 – EMR */}
            <div className="text-center p-3 md:p-6 bg-card border border-border rounded-lg shadow-sm">
              <img src={CDN.emrBadge} alt="EMR Krankenkasse Konform – ZSR P609264" className="h-10 md:h-20 object-contain mx-auto mb-2 md:mb-3 transition-transform duration-300 md:hover:scale-125" loading="lazy" />
      ...
      {/* ═══════════════════ TRAINING ═══════════════════ */}
      <section className="py-6 md:py-10 bg-primary/15" style={deferredSectionStyle}>
        <div className="mx-3 md:mx-auto md:max-w-[1200px]">
          <Link to={getPath("training", language, country)} className="block max-w-5xl mx-auto relative bg-white rounded-2xl overflow-hidden shadow-[0_16px_48px_-8px_rgba(0,0,0,0.3),0_4px_12px_-2px_rgba(0,0,0,0.15)] transition-transform duration-200 hover:scale-[1.01] hover:shadow-[0_20px_56px_-8px_rgba(0,0,0,0.35),0_6px_16px_-2px_rgba(0,0,0,0.18)] cursor-pointer">
            {/* Label + Title */}
            <div className="text-center pt-6 pb-3 md:pt-10 md:pb-4 px-5 md:px-10">
