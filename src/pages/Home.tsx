...
import hero1Mobile from "@/assets/hero-5-mobile.webp";
...
// Hero slider order (5 images): Flipchart (start) → Büro → Active work → Therapeutic session → Conversation at table
const heroDesktop = [
  hero1,
