          ...
          <div className="grid md:grid-cols-[290px_1fr] gap-2 md:gap-4 md:items-stretch">
            ...
            <div className="order-1 md:order-2 flex flex-col items-center text-center md:pl-1 md:h-full md:pt-0 md:pb-1">
              ...
              <button
                ...
                className="mt-3 md:mt-4 md:mb-1 inline-flex items-center justify-center bg-[#c8e6c9] hover:bg-[#a5d6a7] text-black font-medium text-[12px] md:text-[13.5px] px-5 md:px-7 py-1.5 md:py-2 rounded-lg shadow-sm transition-all border border-[#1B3A5C]/40"
              >
