        ...
        <div className="container-main">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 max-w-4xl md:max-w-5xl mx-auto">
            ...
            <div className="text-center p-3 md:p-6 bg-card border border-border rounded-lg shadow-sm">
              <img src={licPsychSeal} alt="Lic. Psych. – Academic Seal" className="h-14 md:h-24 w-14 md:w-24 object-contain mx-auto mb-2 md:mb-3 transition-transform duration-300 md:hover:scale-110" loading="lazy" width={512} height={512} />
            ...
            <div className="text-center p-3 md:p-6 bg-card border border-border rounded-lg shadow-sm flex flex-col items-center justify-center">
              <img src={CDN.logo} alt="Aktiv-Hypnose© Logo" className="h-8 md:h-16 w-auto object-contain shrink-0 mx-auto mb-2 md:mb-3 transition-transform duration-300 md:hover:scale-110" loading="lazy" />
            ...
            {/* 3 – NGH */}
            <div className="text-center p-3 md:p-6 bg-card border border-border rounded-lg shadow-sm">
              <img src={CDN.nghBadge} alt="NGH International Trainer" className="h-10 md:h-20 w-10 md:w-20 object-contain mx-auto mb-2 md:mb-3 transition-transform duration-300 md:hover:scale-110" loading="lazy" />
              <h3 className="font-semibold text-xs md:text-sm text-foreground">NGH International Trainer</h3>
            </div>
            {/* 4 – EMR */}
            <div className="text-center p-3 md:p-6 bg-card border border-border rounded-lg shadow-sm">
              <img src={CDN.emrBadge} alt="EMR Krankenkasse Konform – ZSR P609264" className="h-10 md:h-20 object-contain mx-auto mb-2 md:mb-3 transition-transform duration-300 md:hover:scale-110" loading="lazy" />
