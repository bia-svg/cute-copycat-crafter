...
export default function Home() {
  ...
  const [loadedSlides, setLoadedSlides] = useState<Record<number, string>>({ 0: heroSession, 4: hero1 });
  const [loadedMobile, setLoadedMobile] = useState<Record<number, string>>({ 0: heroSessionMobile, 4: hero1Mobile });
            ...
            <div className="order-1 md:order-2 flex flex-col items-center text-center md:pl-1 md:h-full md:pt-0 md:pb-1">
              ...
              <div className="mt-4 md:mt-5 mb-3 md:mb-1 flex flex-col items-stretch gap-5 md:gap-5 w-full max-w-[320px] md:max-w-[340px]">
                ...
                <Link
                  ...
                  className="group relative overflow-hidden inline-flex items-center justify-center w-full px-5 md:px-7 py-2 md:py-2.5 rounded-2xl bg-gradient-to-b from-[#4FA974] to-[#327E55] hover:from-[#479C6A] hover:to-[#2B7049] text-white font-semibold text-[12.5px] md:text-[13.5px] tracking-[0.01em] border border-[#235C3C]/60 shadow-[0_1px_0_0_rgba(255,255,255,0.32)_inset,0_12px_28px_-8px_rgba(35,92,60,0.38),0_24px_50px_-14px_rgba(35,92,60,0.34)] hover:shadow-[0_1px_0_0_rgba(255,255,255,0.38)_inset,0_16px_36px_-8px_rgba(35,92,60,0.46),0_30px_60px_-14px_rgba(35,92,60,0.40)] hover:-translate-y-0.5 md:hover:-translate-y-[3px] active:translate-y-px transition-all duration-300 ease-out"
                >
                ...
                <Link
                  ...
                  className="group relative overflow-hidden inline-flex items-center justify-center w-full px-5 md:px-7 py-2 md:py-2.5 rounded-2xl bg-gradient-to-b from-[#DCE8F4] to-[#C2D7EA] hover:from-[#CFDDED] hover:to-[#B2CAE2] text-[#0B1F33] font-semibold text-[12.5px] md:text-[13.5px] tracking-[0.01em] border border-[#1B3A5C]/40 hover:border-[#1B3A5C]/60 shadow-[0_1px_0_0_rgba(255,255,255,0.75)_inset,0_12px_28px_-8px_rgba(27,58,92,0.28),0_24px_50px_-14px_rgba(27,58,92,0.24)] hover:shadow-[0_1px_0_0_rgba(255,255,255,0.85)_inset,0_16px_36px_-8px_rgba(27,58,92,0.36),0_30px_60px_-14px_rgba(27,58,92,0.30)] hover:-translate-y-0.5 active:translate-y-px transition-all duration-300 ease-out"
                >
