...
export const anxietyData: ServicePageData = {
  ...
  faqEN: [
    ...
    { q: "Is hypnosis for anxiety scientifically recognized?", a: "Yes — hypnotherapy has been used in psychological and medical fields for many years and is regarded as a recognized method for supporting anxiety, stress reactions, and distressing behavioral patterns. What matters, however, is not just the method itself, but above all how specifically and professionally it is applied. Especially with anxiety, it is important not just to talk about symptoms, but to address the unconscious triggers, evaluation patterns, and automatic body reactions at the root. This is precisely the particular strength of well-founded hypnotherapy: it can help to re-regulate inner alarm reactions and specifically resolve distressing anxiety associations." },
