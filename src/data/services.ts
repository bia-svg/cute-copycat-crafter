...
export const depressionData: ServicePageData = {
  ...
  introCH: [
    ...
    "Depressionen und traumatische Erfahrungen sind meist mehr als nur vorübergehende Zustände. Für viele Betroffene sind sie eng mit tiefen emotionalen Prägungen, wiederkehrenden Gedankenmustern und körperlichen Reaktionen verbunden, die sich nicht einfach bewusst steuern lassen.\n\nOft zeigen sich diese Muster im Alltag durch Antriebslosigkeit, innere Unruhe, Rückzug oder das Gefühl, festzustecken. Genau deshalb reicht es in vielen Fällen nicht aus, nur auf bewusster Ebene zu arbeiten.\n\nHypnose ermöglicht es, direkt mit dem Unterbewusstsein zu arbeiten – dort, wo diese Muster entstanden sind. Emotionale Auslöser, Bewertungen und automatische Reaktionen können gezielt verändert und neu eingeordnet werden.\n\nSo entsteht Schritt für Schritt eine innere Stabilität, die sich auch im Alltag bemerkbar macht – in Form von mehr Ruhe, Klarheit und einem besseren Zugang zu sich selbst."
  ],
  introDE: [
    "Viele Menschen erleben Phasen von Depression, emotionaler Erschöpfung oder innerer Leere. Trotz bewusster Bemühungen fällt es oft schwer, diese Zustände nachhaltig zu verändern.\n\nDer Grund liegt häufig in tief verankerten emotionalen Mustern und unbewussten Reaktionen. Genau hier setzt Hypnose an: Diese inneren Prozesse werden gezielt verändert und neu ausgerichtet.\n\nZiel ist eine spürbare, stabile Veränderung – hin zu mehr innerer Ruhe und Klarheit.",
    "Depressionen und traumatische Erfahrungen sind meist mehr als nur vorübergehende Zustände. Für viele Betroffene sind sie eng mit tiefen emotionalen Prägungen, wiederkehrenden Gedankenmustern und körperlichen Reaktionen verbunden, die sich nicht einfach bewusst steuern lassen.\n\nOft zeigen sich diese Muster im Alltag durch Antriebslosigkeit, innere Unruhe, Rückzug oder das Gefühl, festzustecken. Genau deshalb reicht es in vielen Fällen nicht aus, nur auf bewusster Ebene zu arbeiten.\n\nHypnose ermöglicht es, direkt mit dem Unterbewusstsein zu arbeiten – dort, wo diese Muster entstanden sind. Emotionale Auslöser, Bewertungen und automatische Reaktionen können gezielt verändert und neu eingeordnet werden.\n\nSo entsteht Schritt für Schritt eine innere Stabilität, die sich auch im Alltag bemerkbar macht – in Form von mehr Ruhe, Klarheit und einem besseren Zugang zu sich selbst."
  ...
  introEN: [
    ...
    "Depression and traumatic experiences are usually more than just temporary states. For many people, they are closely linked to deep emotional imprints, recurring thought patterns and physical reactions that cannot simply be controlled consciously.\n\nThese patterns often show up in everyday life as lack of drive, inner restlessness, withdrawal or the feeling of being stuck. This is precisely why working only on a conscious level is in many cases not enough.\n\nHypnosis makes it possible to work directly with the subconscious mind – where these patterns originated. Emotional triggers, evaluations and automatic reactions can be specifically changed and reframed.\n\nStep by step, this creates an inner stability that becomes noticeable in everyday life – in the form of more calm, clarity and a better connection to yourself."
  ],
  sectionsCH: [
    {
  ...
  faqEN: [
    { q: "Can hypnosis replace psychotherapy?", a: "Hypnosis can in many cases be a very direct and effective method for specifically addressing emotional causes and unconscious stress patterns. While classical psychotherapy often works more strongly through conscious conversations, analysis, and long-term behavioral change, hypnosis targets the deeper emotional and subconscious associations more directly. This means many topics can often be reached more quickly and specifically. Nevertheless, it always depends on the individual situation. Especially with severe depression or when a possible organic or medical background is suspected, additional medical or psychotherapeutic clarification should always take place. In many cases, hypnosis can be a very valuable standalone method — in more complex or severe cases, it can equally be used meaningfully alongside psychotherapy or medical treatment." },
