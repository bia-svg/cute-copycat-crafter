...
export const anxietyData: ServicePageData = {
  ...
  faqCH: [
    { q: "Kann Hypnose bei allen Arten von Ängsten helfen?", a: "Ja, Hypnose kann bei verschiedensten Ängsten und Phobien helfen – von Flugangst über soziale Ängste bis hin zu Panikattacken und Platzangst." },
    { q: "Ist Hypnose bei Ängsten wissenschaftlich anerkannt?", a: "Ja, zahlreiche Studien belegen die Wirksamkeit von Hypnotherapie bei Angststörungen. Die Methode wird auch von vielen Psychologen und Ärzten empfohlen." },
    { q: "Wie viele Sitzungen sind nötig?", a: "Die Anzahl der Sitzungen hängt von der Art und Intensität der Angst ab. Viele Klienten berichten bereits nach 1-3 Sitzungen von deutlichen Verbesserungen." },
  ],
  faqEN: [
...
export const weightData: ServicePageData = {
  ...
  faqEN: [
    ...
    { q: "Does hypnosis help with emotional eating?", a: "Yes, hypnosis is particularly effective for emotional eating, as it directly addresses the subconscious triggers." },
  ],
};
...
export const stressData: ServicePageData = {
  ...
  faqEN: [
    ...
    { q: "How many sessions are needed for burnout?", a: "The number depends on the severity of the situation. Many clients report significant improvements after 2-4 sessions." },
  ],
};
...
export const depressionData: ServicePageData = {
  ...
  faqEN: [
    ...
    { q: "Does hypnosis help with childhood trauma?", a: "Yes, hypnosis can be particularly effective in processing childhood trauma, as it works directly with the subconscious where these experiences are stored." },
  ],
};
