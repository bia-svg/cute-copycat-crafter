...
export const smokingData: ServicePageData = {
  ...
  faqCH: [
    { q: "Wie viele Sitzungen brauche ich, um mit dem Rauchen aufzuhören?", a: "In vielen Fällen reicht bereits eine gezielte Intensivsitzung aus, um mit dem Rauchen aufzuhören. Gerade bei einer Raucherentwöhnung mit Hypnose geht es nicht darum, möglichst viele Sitzungen durchzuführen, sondern die entscheidenden unbewussten Verknüpfungen gezielt zu verändern.\n\nViele Klienten entscheiden sich bewusst für eine Raucherentwöhnung mit Hypnose, weil sie nicht mehr gegen sich selbst kämpfen möchten. Ziel ist es, nicht nur kurzfristig rauchfrei zu werden, sondern sich innerlich wirklich als Nichtraucher zu fühlen – ohne ständigen inneren Druck oder klassische Entzugsprobleme.\n\nJe nach Ausgangssituation, Dauer der Rauchgewohnheit und individuellen Mustern kann es sinnvoll sein, den Prozess durch eine zweite Sitzung zu stabilisieren. Dies ist insbesondere dann der Fall, wenn Rauchen stark mit Stress, Gewohnheiten oder emotionalen Auslösern verbunden ist.\n\nEntscheidend ist dabei nicht die Anzahl der Sitzungen, sondern die Qualität der Veränderung im Unterbewusstsein. Durch die Hypnose werden genau diese inneren Prozesse gezielt angesprochen, sodass eine nachhaltige Veränderung möglich wird.\n\nDas Ziel der Raucherentwöhnung ist nicht nur, mit dem Rauchen aufzuhören, sondern dauerhaft rauchfrei zu bleiben und sich stabil als Nichtraucher zu erleben." },
  ...
  faqEN: [
    { q: "How many sessions do I need to quit smoking?", a: "In many cases, a single targeted intensive session is already enough to stop smoking. With smoking cessation through hypnosis, the goal is not to complete as many sessions as possible, but to specifically transform the decisive subconscious associations.\n\nMany clients consciously choose smoking cessation with hypnosis because they no longer want to fight against themselves. The aim is not just to be smoke-free in the short term, but to truly feel like a non-smoker from within – without constant inner pressure or classic withdrawal issues.\n\nDepending on the starting situation, the duration of the smoking habit, and individual patterns, it can be useful to stabilize the process with a second session. This is especially the case when smoking is strongly linked to stress, habits, or emotional triggers.\n\nWhat matters is not the number of sessions, but the quality of the change at the subconscious level. Through hypnosis, exactly these inner processes are specifically addressed, making a lasting change possible.\n\nThe goal of smoking cessation is not only to stop smoking, but to remain permanently smoke-free and to experience yourself stably as a non-smoker." },
