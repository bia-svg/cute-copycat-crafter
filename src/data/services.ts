...
export const stressData: ServicePageData = {
  ...
  faqEN: [
    { q: "Can hypnosis help with chronic stress?", a: "Yes, hypnosis can be very effective in supporting chronic stress — not just by providing short-term relaxation, but by specifically influencing the actual inner stress patterns. Many people are under pressure for extended periods until the body enters a permanent state of alarm and the nervous system begins to evaluate even normal everyday situations as stressful. This is exactly where hypnosis comes in: it can help reduce the automatic stress response, calm the nervous system, and build greater inner calm and emotional stability. At the same time, it supports strengthening your own resilience, setting better boundaries, and dealing with pressures more consciously and calmly. This creates not just relaxation in the moment, but often a lasting change in how you handle stress." },
    { q: "How do I know if I'm at risk for burnout?", a: "Typical signs of burnout risk include persistent exhaustion, sleep problems, inner restlessness, concentration difficulties, racing thoughts, emotional emptiness, lack of motivation, and the feeling of having no real energy left despite great effort. Many affected individuals also notice that they can barely switch off anymore, constantly feel responsible, struggle to set boundaries, and keep pushing themselves to perform more, function, or please others. This is often where the real danger lies: burnout develops not only from external stress, but frequently from deeply anchored inner patterns such as performance pressure, fear of loss, fear of rejection, or the feeling of constantly having to be strong. If you feel permanently drained, internally empty, overwhelmed, or as if you are in 'permanent overdrive,' this is a serious warning sign." },
    { q: "How many sessions are needed for burnout?", a: "This cannot be determined in a general way, as burnout must always be considered very individually. Key factors include the severity of exhaustion, duration of overload, inner tension, possible psychosomatic symptoms, and willingness to consciously change stressful patterns in daily life. Hypnosis is a very direct and effective tool because it specifically targets the emotional and subconscious stress patterns that often underlie burnout. Some clients feel significant relief after just one intensive session — noticeably clearer, calmer, and more internally stable. Whether further sessions are beneficial usually only becomes apparent after the first intensive session and in the days that follow. Only then can it be realistically assessed whether an additional follow-up session is helpful or necessary." },
  ],
};
