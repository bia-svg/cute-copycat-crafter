...
export const smokingData: ServicePageData = {
  ...
  introCH: [
    ...
    "Die Raucherentwöhnung mit Hypnose setzt genau hier an: an den unbewussten Ursachen. Statt das Rauchen zu bekämpfen, werden die inneren Verknüpfungen gezielt verändert.",
  ...
  introEN: [
    ...
    "Smoking cessation with hypnosis works exactly here: at the unconscious causes. Instead of fighting the smoking, the inner associations are specifically transformed.",
    "This makes it possible to quit smoking and become permanently smoke-free – without constant inner pressure or classic withdrawal problems.",
    "Many people consciously choose this path because they no longer want to struggle, but are looking for a sustainable solution to be able to quit smoking.",
    "The goal is not only to stop smoking, but to feel stable as a non-smoker – long-term and without relapse."
  ],
  sectionsCH: [
    {
