...
export const smokingData: ServicePageData = {
  ...
  h1EN: "Effective Smoking Cessation with Hypnosis",
  ...
  faqEN: [
    { q: "How many sessions do I need to quit smoking?", a: "In many cases, a single targeted intensive session is already sufficient to sustainably support smoking cessation. The key factor is that your conscious will is truly present and that you have clear personal reasons for wanting to quit. In the intensive session, the work goes beyond surface-level behavior — it specifically targets the emotional and subconscious associations that have been maintaining the smoking habit. Cigarettes are often subconsciously linked to stress relief, control, security, habit, or reward — even though you consciously know they don't help. These learned emotional patterns are precisely addressed and realigned during hypnosis. Depending on your history, inner motivation, and strength of the habit, an additional session may be beneficial in some cases — but often a single intensive session is already a very powerful start into a smoke-free life." },
