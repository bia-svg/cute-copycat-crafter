...
export const smokingData: ServicePageData = {
  ...
  faqEN: [
    ...
    { q: "Does health insurance cover hypnosis costs?", a: "In Switzerland, our services are EMR/health insurance compliant (ZSR No. P609264). Many supplementary insurances cover part of the costs depending on your plan — often under the category 'Autogenic Training' in the area of complementary medicine. Please check directly with your insurance provider in advance. In Germany, these services are generally not covered by health insurance. However, depending on your individual situation, tax deductibility may be possible, as sessions are conducted through a registered institute. Please discuss this with your tax advisor if applicable." },
