...
export const childrenData: ServicePageData = {
  ...
  faqCH: [
    ...
    { q: "Bei welchen Themen k\u00F6nnen Kinder geholfen werden?", a: "Wir arbeiten mit einer Vielzahl von Anliegen bei Kindern und Jugendlichen, darunter Pr\u00FCfungs\u00E4ngste, allgemeine Versagens\u00E4ngste, Verlust\u00E4ngste, Unsicherheiten, mangelndes Selbstvertrauen sowie Schwierigkeiten mit Motivation, Konzentration und schulischer Leistung. Auch Themen wie Selbstbewusstsein st\u00E4rken, Ziele besser erreichen, klarer denken und sich besser fokussieren zu k\u00F6nnen, stehen h\u00E4ufig im Mittelpunkt. Dar\u00FCber hinaus helfen wir dabei, emotionale Einfl\u00FCsse fr\u00FChzeitig zu erkennen, besser zu verstehen und gezielt zu bew\u00E4ltigen. Gerade in wichtigen Entwicklungsphasen k\u00F6nnen unbewusste Blockaden entstehen, die Verhalten, Gef\u00FChle und Leistung beeinflussen \u2013 diese k\u00F6nnen mit den passenden Methoden oft sehr wirksam bearbeitet werden." },
  ],
  faqEN: [
    ...
    { q: "What topics can children be helped with?", a: "We work with a wide range of concerns in children and teenagers, including exam anxiety, general fear of failure, fear of loss, insecurities, lack of self-confidence, and difficulties with motivation, concentration, and academic performance. Topics such as strengthening self-confidence, achieving goals more effectively, thinking more clearly, and being able to focus better are also frequently central. In addition, we help to recognize emotional influences early, understand them better, and address them in a targeted way. Especially during important developmental phases, unconscious blockages can arise that influence behavior, feelings, and performance \u2013 these can often be addressed very effectively with the right methods." },
  ],
};
