...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { tag: "p", text: "Mit einer durchschnittlichen Bewertung von 5.0 Sternen bei über { tag: "p", text: "Mit einer durchschnittlichen Bewertung von 5.0 Sternen bei über 266 Google-Bewertungen gehört die Praxis von David J. Woods zu den bestbewerteten Hypnosetherapie-Praxen in der Schweiz. Klienten heben besonders die professionelle Atmosphäre, die schnellen Ergebnisse und die nachhaltige Wirkung hervor." }, gehört die Praxis von David J. Woods zu den bestbewerteten Hypnosetherapie-Praxen in der Schweiz. Klienten heben besonders die professionelle Atmosphäre, die schnellen Ergebnisse und die nachhaltige Wirkung hervor." },
      { tag: "h3", text: "Weitere interessante Beiträge" }
    ]
  },
  {
