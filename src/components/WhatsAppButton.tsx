...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className="fixed bottom-1 right-2 z-[39] flex items-center gap-1.5 bg-cta/90 hover:bg-cta text-white rounded-full shadow-md hover:shadow-lg transition-all hover:scale-[1.03] md:bottom-5 md:right-5 px-4 py-1.5 md:px-5 md:py-2 backdrop-blur-sm"
      aria-label="WhatsApp"
    >
