...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className="fixed bottom-24 right-4 z-[39] flex items-center gap-1.5 bg-[#4CAF50]/90 hover:bg-[#43A047] text-white rounded-full shadow-md hover:shadow-lg transition-all hover:scale-[1.03] md:bottom-5 md:right-5 px-4 py-1.5 md:px-5 md:py-2 backdrop-blur-sm"
      aria-label="WhatsApp"
    >
