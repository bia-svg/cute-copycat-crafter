...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className="fixed bottom-7 right-2 z-[39] flex items-center gap-2 bg-[#4CAF50]/90 hover:bg-[#43A047] text-white rounded-full shadow-md hover:shadow-lg transition-all hover:scale-[1.03] md:bottom-5 md:right-5 px-5 py-2 md:px-6 md:py-2.5 backdrop-blur-sm border border-[#1B3A5C]/75"
    ...
    >
      ...
      <span className="text-xs md:text-sm font-medium whitespace-nowrap tracking-wide">
        {isEN ? "WhatsApp / Quick-Contact" : "WhatsApp / Schnell-Kontakt"}
      </span>
    </a>
  );
}
