...
export default function Header() {
  ...
  const aboutItems = [
    ...
    { icon: <Star className="w-5 h-5" />, label: isDE ? "Kundenmeinungen" : "Testimonials", { icon: <Star className="w-5 h-5" />, label: isDE ? "Kundenmeinungen" : "Testimonials", desc: isDE ? "★ 5.0 bei Google · 266 Bewertungen" : "★ 5.0 at Google · 266 reviews", href: getPath("testimonials", language, country) },, href: getPath("testimonials", language, country) },
