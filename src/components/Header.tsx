...
export default function Header() {
  ...
  const aboutItems = [
    ...
    { icon: <Star className="w-5 h-5" />, label: isDE ? "Kundenmeinungen" : "Testimonials", desc: isDE ? "★ 5.0 bei Google · 263 Bewertungen" : "★ 5.0 at Google · 263 reviews", href: getPath("testimonials", language, country) },
    ...
    <header className="sticky top-0 z-50 bg-card border-b border-border" style={{ contentVisibility: "visible" }}>
      ...
      <div className="container-main flex items-center justify-between h-16">
        <Link to={getPath("home", language, country)} className="flex items-center gap-2">
          <img src={CDN.logo} alt="David J. Woods – Hypnose und Psychologie Logo" className="h-12" width="144" height="48" />
        </Link>
