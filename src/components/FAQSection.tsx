  ...
  return (
    <section className="bg-[#E8EDF3] border-y border-[#D8E0EA]">
      <div className="container-main py-9 md:py-12">
        ...
        <div className="max-w-2xl md:max-w-4xl lg:max-w-5xl mx-auto bg-white/80 backdrop-blur-sm border border-[#E8EDF3] rounded-3xl shadow-[0_4px_20px_rgba(27,58,92,0.05)] p-3 md:p-5 lg:p-6">
          <Accordion
            type="single"
            collapsible
          ...
          >
            {items.map((item, i) => (
              <AccordionItem
                key={i}
                value={`faq-${i}`}
                className="group border border-[#E8EDF3] bg-white rounded-2xl px-5 md:px-6 shadow-[0_1px_2px_rgba(27,58,92,0.04)] hover:border-[#2E7D32]/40 hover:shadow-[0_2px_6px_rgba(46,125,50,0.06)] transition-all data-[state=open]:bg-[#F4F9F4] data-[state=open]:border-[#2E7D32]/40 data-[state=open]:shadow-[0_2px_8px_rgba(46,125,50,0.08)]"
              >
                <AccordionTrigger
