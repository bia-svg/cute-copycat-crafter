...
const prefixRedirects: [string, string][] = [
  ...
  ["/blog/", `${defined}/blog`],
  ["/referenz/", `${defined}/tv-medien`],
  ["/events/", `${defined}/ausbildung`],
  ["/category/", `${defined}/blog`],
  ["/tagesseminar", `${defined}/ausbildung`],
  ["/hypnose-ausbildung-deutschland", `${defined}/ausbildung`],
  ["/professionelles", `${defined}/ausbildung`],
